module.exports = function(grunt) {
  ...
  fileConfig = {
    ...
    dist: {
      client: 'dist/js/taylor.js',
      css: 'dist/css/taylor.css'
    },
    files: {
      mock: ['mockup/*', 'mockup/**/*'],
  ...
  taskConfig = {
    ...
    clean: {
      ...
      assets: {
        src: ['<%= dir.dist %>css/fonts/**', '<%= dir.dist %>img/', '<%= dir.dist %>favicon.ico']
      }
    },
    mkdir: {
      tmp: {
          ...
          reporter: {
            ...
            fileTasks: function(file, tasks, options) {
              ...
              tasks.forEach(function(task) {
                return result += '[' + task.lineNumber + ' - ' + task.priority + ']' + task.line + '\n';
              });
              return result += '\n\n';
            },
            footer: function() {
