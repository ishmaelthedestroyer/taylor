...
Taylor::_bindButtons = () ->
  ...
  bindButton @_header, 'append-h1'

  return @

Taylor::_execFormatBlock = (type) ->
  selectionData = Taylor::_getSelectionData Taylor::_selection.anchorNode
...
Taylor::_checkSelection = () ->
  ...
  selectionElement = Taylor::_getSelectionElement()
  Taylor::_checkSelectionElement newSelection, selectionElement

  return @

Taylor::_checkSelectionElement = (newSelection, selectionElement) ->
  @_selection = newSelection
  @_selectionRange = @_selection.getRangeAt 0
...
Taylor::_getSelectionData = (element) ->
  tagName = ''
  ...
  while element and @_parentElements.indexOf(tagName) is -1
